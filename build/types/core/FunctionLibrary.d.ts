...
export declare function createCapsuleGeometry(
  radius?: number,
  height?: number,
  N?: number
): THREE.Geometry;
 ...
 */
export declare function appplyVectorMatrixXZ(
  a: THREE.Vector3,
  b: THREE.Vector3
): THREE.Vector3;
export declare function round(value: number, decimals?: number): number;
export declare function roundVector(
 ...
 */
export declare function getAngleBetweenVectors(
  v1: THREE.Vector3,
  v2: THREE.Vector3,
  dotTreshold?: number
): number;
 ...
 */
export declare function getSignedAngleBetweenVectors(
  v1: THREE.Vector3,
  v2: THREE.Vector3,
...
export declare function springV(
...
export declare function getRight(
  obj: THREE.Object3D,
  space?: Space
): THREE.Vector3;
export declare function getUp(
  obj: THREE.Object3D,
  space?: Space
): THREE.Vector3;
export declare function getForward(
  obj: THREE.Object3D,
  space?: Space
): THREE.Vector3;
export declare function getBack(
  obj: THREE.Object3D,
  space?: Space
): THREE.Vector3;
